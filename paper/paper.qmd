...
Starting from the second claim, we will be using the main experiment data. Before manipulating it into graphs and tables, we can first understand the cleaned data better with summary statistics. 
