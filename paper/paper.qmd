...
eduimpact <- main_cleaned |> mutate(support = ifelse(
  ...
  mutate(edu_words = case_when(
    
  ))

eduimpact |>
  ggplot(mapping = aes(x = education, fill = support)) +
  geom_bar() +
