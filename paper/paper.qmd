...
#| echo: false
#| label: tbl-sum
#| fig-cap: Summary Statistics on Men Who Participated in the Main Experiment
...
As seen in @tbl-sum above, there are less than 500 data points present after removing single men as well as any empty data points used in the making of the summary statistics, contrary to the claims of Bursztyn et.al.
